...
![img](imgs/640-1559205137019.webp)
...
![img](imgs/640-1559218556383.webp)
...
![img](imgs/640-1559219797840.webp)
...
![img](imgs/640-1559222366483.webp)
...
![img](imgs/640-1559222403321.webp)
...
![img](imgs/640-1559222718493.webp)
...
1.  将预训练模型当做一个特征提取器，直接将预训练模型的输出层去掉，然后使用去掉输出层之后的最后一层输出作为特征输入到我们自己精心设计好的Task-specific模型中去，在训练过程中，作为特征提取器的部分（比如BERT Encoder）的参数是不变的。

    另外，特征提取器并不一定只能用最后一层的输出向量，也可以使用中间的某些层，甚至也可以借鉴ELMo的做法，在各层之间利用一个softmax来学习各自的权值，或者也可以尝试一些更为复杂的各层组合方式；

![img](imgs/640-1559222749852.webp)
...
![img](imgs/640-1559222799364.webp)
...
![img](imgs/640-1559222812457.webp)
...
![img](imgs/640-1559222896236.webp)
...
![img](imgs/640-1559222913181.webp)
...
![img](imgs/640-1559222942870.webp)
...
[一文看懂NLP神经网络发展历史中最重要的8个里程碑！](<https://www.colabug.com/5070686.html>)

[Representation Learning: A Review and New Perspectives](http://www.cs.princeton.edu/courses/archive/spring13/cos598C/Representation Learning - A Review and New Perspectives.pdf)
